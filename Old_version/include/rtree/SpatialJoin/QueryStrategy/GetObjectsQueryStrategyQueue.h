...
#ifndef K2_RASTER_GETOBJECTSQUERYSTRATEGY_QUEUE_H_
#define K2_RASTER_GETOBJECTSQUERYSTRATEGY_QUEUE_H_
...
namespace k2raster_rtree_static {
    ...
    class GetObjectsQueryStrategyQueue : public GetObjectsQueryStrategy {
    public:
        /****** Process MBR ******/
    ...
    }; // END CLASS GetObjectsQueryStrategyQueue

} // END NAMESPACE k2raster_rtree_static

#endif // K2_RASTER_GETOBJECTSQUERYSTRATEGY_QUEUE_H_
