...
#ifndef K2_RASTER_GETOBJECTSQUERYSTRATEGY_TREE_H_
#define K2_RASTER_GETOBJECTSQUERYSTRATEGY_TREE_H_
...
namespace k2raster_rtree_static {
    ...
    class GetObjectsQueryStrategyTree : public GetObjectsQueryStrategy {
    ...
    private:
        ...
        map<ulong, MinNodeTreeNode *> nextMBRs;
        map<ulong, MinNodeTreeNode *>::iterator next;
...
#endif // K2_RASTER_GETOBJECTSQUERYSTRATEGY_TREE_H_
