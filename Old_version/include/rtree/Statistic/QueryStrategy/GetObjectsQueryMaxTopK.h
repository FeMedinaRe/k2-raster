...
#ifndef K2_RASTER_GETOBJECTSQUERYMAXTOP_K_H_
#define K2_RASTER_GETOBJECTSQUERYMAXTOP_K_H_
...
namespace k2raster_rtree_static {
    ...
    class GetObjectsQueryMaxTopK : public GetObjectsQueryTopK<cmpPriorityPointerMBRMax> {
    public:
...
#endif // K2_RASTER_GETOBJECTSQUERYMAXTOP_K_H_
