...
#ifndef K2_RASTER_GETOBJECTSQUERYSTRATEGY_LEAVES_H_
#define K2_RASTER_GETOBJECTSQUERYSTRATEGY_LEAVES_H_
...
namespace k2raster_rtree_static {
    ...
    class GetObjectsQueryStrategyLeaves : public GetObjectsQueryStrategy {
    public:
    ...
    private:
        ...
        bool first;
        MinSubMatrix *rootNode;

    }; // END CLASS GetObjectsQueryStrategy

} // END NAMESPACE k2raster_rtree_static

#endif // K2_RASTER_GETOBJECTSQUERYSTRATEGY_LEAVES_H_
