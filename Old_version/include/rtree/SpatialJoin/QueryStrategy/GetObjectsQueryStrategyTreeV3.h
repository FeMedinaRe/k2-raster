...
#ifndef K2_RASTER_GETOBJECTSQUERYSTRATEGY_TREEV3_H_
#define K2_RASTER_GETOBJECTSQUERYSTRATEGY_TREEV3_H_
...
namespace k2raster_rtree_static {
    ...
    class GetObjectsQueryStrategyTreeV3 : public GetObjectsQueryStrategy {
...
#endif // K2_RASTER_GETOBJECTSQUERYSTRATEGY_TREEV3_H_
