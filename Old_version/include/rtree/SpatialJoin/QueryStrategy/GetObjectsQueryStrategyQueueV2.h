...
#ifndef K2_RASTER_GETOBJECTSQUERYSTRATEGY_QUEUE_V2_H_
#define K2_RASTER_GETOBJECTSQUERYSTRATEGY_QUEUE_V2_H_
...
namespace k2raster_rtree_static {
    ...
    class GetObjectsQueryStrategyQueueV2 : public GetObjectsQueryStrategy {
    public:
        /****** Process MBR ******/
    ...
    private:
        ...
        stack<id_type> ids;
        stack<uint> nChildren;
        stack<MinSubMatrix *> minSubMatrices;

    }; // END CLASS GetObjectsQueryStrategyQueueV2

} // END NAMESPACE k2raster_rtree_static

#endif // K2_RASTER_GETOBJECTSQUERYSTRATEGY_QUEUE_V2_H_
